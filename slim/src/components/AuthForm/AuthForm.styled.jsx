...
export const WrapperAuthform = styled.article` 
    display: flex;
...
export const TitleAuthform = styled.h1` 
...
export const ButtonLoginAuthform = styled.button`
    margin-top: 282px;
    width: 181px;
    height: 44px;   
    left: 0px;
...
export const ButtonRegisterAuthform = styled.button`
    margin-top: 282px; 
    width: 181px;
    height: 44px;   
    left: 229px;
